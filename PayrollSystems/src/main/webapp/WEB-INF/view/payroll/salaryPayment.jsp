                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <form action="${salaryPaymentURL}" method="get">
                                     <div class="row">
                                         <div class="col-md-3">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        <core:forEach var="keyAndVal" items="${keyAndValue}">
                                            ...
                                            <tr>
                                                ...
                                                <td>${salary}</td>
                                                <td>Paid</td>
                                                <td><a href="${salaryPaymentURL}?empId=${empId}&month=${month}&year=${year}&shiftId=${shiftId}" class="fa fa-eye"> View</a>  | <a href="" class="fa fa-money"> Pay</a>  </td>
                                            </tr>
                                        </core:forEach>
                                    </tbody>
                                </table>--%>
                               <core:forEach var="keyAndVal" items="${keyAndValue}">
                                            ...
                                            <core:set var="empname" value="${keyAndVal.key}" />
                                            <core:set var="attendance" value="0" />
                                            <core:set var="salary" value="0" />
                                            ...
                                            <core:forEach var="values" items="${keyAndVal.value}" varStatus="status">
                                                 ...
                                                 <core:if test="${values.atdCheckin ne 'ci' && values.atdCheckin ne '' && values.atdCheckout ne 'co' && values.atdCheckout ne '' && values.atdDate ne ''}">
                                                     ...
                                                     <core:set var="month" value="${values.atdMonthNumber}" />
                                                     <core:set var="year" value="${values.atdYear}" />
                                                     <core:set var="date" value="${values.atdDate}" />
                                                     <core:set var="shiftId" value="${values.shiftId}" />
                                                 </core:if>
                                            </core:forEach>
                               </core:forEach>
                               <table border="1" width="90%" style="text-align: center;">
                                   <tr>
                                       <th  colspan="2">
                                           <h2>IntelExcel Iformation Technology</h2>
                                       </th>
                                   </tr>
                                   <tr>
                                       <td  colspan="2">
                                           <h6>Address: <span style="font-size: 12px;">Baldia town karachi</span></h6>
                                           <h6>Phone: <span style="font-size: 12px;">+923242806949</span></h6>
                                           <h6>Email: <span style="font-size: 12px;">Masoodazhar60@gmail.com</span></h6>
                                           <h6>Website: <span style="font-size: 12px;">www.intelexcel.com</span></h6>
                                       </td>
                                   </tr>
                                   <tr>
                                       <th  colspan="2">
                                   ...
                                   <tr height="50">
                                       ...
                                       <td colspan="" width="50%"><h6><b>Cash Receipt#: </b><span>2234556</span></h6></td>
                                       <td colspan=""><h6><b>Date:</b> <span>${date}</span></h6></td>
                                   </tr>
                                   <tr>
                                       <td style="text-align: left">
                                           <table align="center" border="1" style="margin: 0 0 0 150px;">
                                            <tr>
                                                <td colspan="2"><b>Employee ID</b> <span>${empId}</span></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"><b>Employee Name</b> <span>${empname}</span></td>
                                            </tr>
                                        </table>
                                       </td>  
                                      <td colspan="">&nbsp;</td>
                                  ...
                                  <!-- <tr height="50">
                                       <td width="50%" style="text-align: right;"><b>Cash Recieved From:</b> __________________________________</td>
                                       <td style="text-align: left;">_____________________  &nbsp;<b>Of $</b>_________________________</td>
                                   </tr>
                                   <tr height="50">
                                       <td colspan="12"><b>For</b>_________________________________________________________________________________________________________</td>
                                   </tr>-->
                                  <tr>
                                      <td colspan="2">
                                   ...
                                   <tr height="60" align="right">
                                       <td>
                                           <table width="65%">
                                               <tr>
                                                   <td width="1%">Cash</td>
                                                   <td style="border: solid 1px;" width="5%">&nbsp;</td>
                                                   <td width="70%"></td>
                                               </tr>
                                               <tr>
                                                   <td>Cheque</td>
                                       ...
                                       <td colspan="">
                                           <table width="65%" align="left">
                                               ...
                                               <tr>
                                                   <td></td>
                                                   <td style="text-align: right;">Signed By__________________________</td>
                                               </tr>

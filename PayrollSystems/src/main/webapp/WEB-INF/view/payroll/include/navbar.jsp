                ...
                <div class="tab-pane animated fadeIn active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="active"><a href="${homePage}"><i class="icon-speedometer"></i><span>HRh Dashboard</span></a></li>
                            <li class=""><a href="${aallEmployeeUrl}"><i class="icon-users"></i><span>Employee System</span></a></li>
                            <li class=""><a href="${attendancePageUrl}"><i class="icon-credit-card"></i><span>Attendance</span></a></li>
                            <li class=""><a href="${manageEmployeePageURL}"><i class="icon-credit-card"></i><span>Payments</span></a></li>
                        </ul>
                    </nav>
                </div>

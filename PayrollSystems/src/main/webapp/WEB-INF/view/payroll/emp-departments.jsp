                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                        <core:forEach var="all" items="${allDepartment}" varStatus="st">
                                        <tr>
                                            <td>${st.count}</td>
                                            <td><h6 class="mb-0">${all.depName}</h6></td>
                                            <td>${all.depHead}</td>
                                            <td>${all.depNumberofEmployee}</td>
                                            <td>
                                                <a href="${editDepartmentPageUrl}?id=${all.depId}" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></a>
                                                <a href="${deleteDepartmentURL}?id=${all.depId}" class="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" onclick="return confirm('are you sure?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </core:forEach>
                                        </tr>
                                    </tbody>
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="form-group">                                    
                            <form:input required="true" path="Department.depName" class="form-control" placeholder="Department Name"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group"> 
                            <form:input required="true" path="Department.depHead" class="form-control" placeholder="Departments Head" />
                       
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">     
                            <form:input required="true" path="Department.depNumberofEmployee" type="number"  class="form-control" placeholder="No of Employee"/>
                            <form:input path="Department.depStatus" value="1" type="hidden"/>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from thememakker.com/templates/lucid/hr/html/light/emp-departments.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Oct 2018 05:27:16 GMT -->
</html>

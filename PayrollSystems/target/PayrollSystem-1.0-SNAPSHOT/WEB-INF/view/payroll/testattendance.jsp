...
<%@page import="com.payroll.payrollsystem.services.AttendanceService" %>  
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-md-12">
                       ...
                       <form:input path="Attendance.atdAcnumber" class="form-control" placeholder="Employee A/C Number" />
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <form:select class="form-control mb-3 show-tick" path="Attendance.atdName">
                                <form:option value="0">Select Emolyee Name</form:option>
                                <core:forEach var="allEmp" items="${allEmployee}">
                                <form:option value="${allEmp.empName}">${allEmp.empName}</form:option>
                                </core:forEach>
                            </form:select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                             <form:select class="form-control mb-3 show-tick" path="Attendance.atdDepartment">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <form:input path="Attendance.atdDate" data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Select Date"/>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <form:input path="Attendance.atdTime" data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Select Time"/>
...
<script>
    ...
    $(this).children('td:eq(0)').ap('<td><i class="icon-close btn-danger"></i></td>');
    });

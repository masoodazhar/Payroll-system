    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        <div class="for-label">Department Name</div>
                        <div class="form-group"> 
                            
                            <form:input required="true" class="form-control" path="Department.depName" value="${departmentRow.depName}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="for-label">Department Head</div>
                        <div class="form-group">                                    
                           <form:input required="true" class="form-control" path="Department.depHead" value="${departmentRow.depHead}"/>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="for-label">Department No-of Employee</div>
                        <div class="form-group">                                    
                            <form:input required="true" class="form-control" path="Department.depNumberofEmployee" value="${departmentRow.depNumberofEmployee}"/>
                        </div>
                    </div>    
                    <div class="col-md-4">
                        <div class="form-group">                                   
                             <form:input type="hidden" path="Department.depStatus" value="${departmentRow.depStatus}"/>
                             <form:input path="Department.depId" type="hidden" value="${departmentRow.depId}"/>
                        </div>
                    </div>

                            ...
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0 c_list">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="mb-0">${allPay.payName}</h6>                                            
                                            </td>
                                          
                                            <td>${allPay.payPaid}</td>
                                            <td>${allPay.payOvertimerate}</td>
                                            <td>${allPay.payPaymentmethod}</td>
                                            <td>
                                                <core:if test="${allPay.payStatus eq 1}"><span class="btn btn-success">Active</span></core:if>
                                                <core:if test="${allPay.payStatus eq 0}"><span class="btn btn-danger">Deactive</span></core:if>
                                            </td>
                                            <td>
                                                <a href="${updatePaymentPageURL}?id=${allPay.payId}" class="btn btn-sm btn-success" title="Approved"><i class="fa fa-edit"></i></a>
                                                <a onclick="return confirm('Are you sure?')" href="${deletePaymentURL}?id=${allPay.payId}" class="btn btn-sm btn-outline-danger js-sweetalert" title="Declined"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        </core:forEach>
                                    </tbody>
...
<div class="modal animated lightSpeedIn" id="Leave_Request" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form:form action="${addPaymentURL}" modelAttribute="command">
            <div class="modal-body">
                <div class="row clearfix">
                     <div class="col-md-6">
                        <div class="form-group">
                            <form:input required="true" path="PaymentSetting.payName" class="form-control" placeholder="Payment Name"/>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <form:input required="true" path="PaymentSetting.payOvertimerate" class="form-control" placeholder="Payment Overtimerate Rate"/>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <form:select required="true" class="form-control mb-3 show-tick" path="PaymentSetting.payPaid">
                            <form:option value="">When is Employee Paid</form:option>
                            <form:option value="Weekly">Weekly </form:option>
                            <form:option value="Fortnight">Fortnight</form:option>
                            <form:option value="4-Weekly">4-Weekly</form:option>
                    ...
                    <div class="col-md-12">
                        <form:select required="true" class="form-control mb-3 show-tick" path="PaymentSetting.payPaymentmethod">
                            ...
                            <form:option value="Credit transfer">Credit transfer</form:option>
                        </form:select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                        <form:input type="hidden" value="1" path="PaymentSetting.payStatus"/>
                        </div>
                    </div>                    
                </div>
            </div>
